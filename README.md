...
Aplikasi portal manajemen proyek berbasis backend Node.js/Express, frontend React, dan database MySQL.
...
- Dokumentasi final tersedia dalam format PDF di folder `docs/pdf/`.
